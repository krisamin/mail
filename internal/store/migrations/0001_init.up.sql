...
CREATE INDEX idx_app_passwords_user ON app_passwords(user_id) WHERE revoked_at IS NULL;
...
CREATE INDEX idx_message_blobs_sha256 ON message_blobs(sha256);
...
CREATE TABLE messages (
    ...
    blob_id       BIGINT NOT NULL REFERENCES message_blobs(id),
