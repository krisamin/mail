...
export const ko = {
  ...
  "adminAccount.quotaPlaceholder": "GB (빈칸=무제한)",
  ...
  "webmail.title": "메일함",
  "webmail.nav": "메일함",
  "webmail.compose": "새 메일",
  "webmail.refresh": "새로고침",
  "webmail.empty": "메일이 없어요.",
  "webmail.loadMore": "더 보기",
  "webmail.noSubject": "(제목 없음)",
  "webmail.from": "보낸 사람",
  "webmail.to": "받는 사람",
  "webmail.cc": "참조",
  "webmail.subject": "제목",
  ...
  "webmail.reply": "답장",
  "webmail.delete": "삭제",
  "webmail.deleteForever": "영구 삭제",
  "webmail.confirmDeleteForever": "이 메일을 영구 삭제할까요? 되돌릴 수 없어요.",
  "webmail.archive": "보관",
  "webmail.markUnread": "안 읽음으로",
  "webmail.flag": "별표",
  "webmail.unflag": "별표 해제",
  "webmail.attachment": "첨부파일",
  "webmail.raw": "원본 (.eml)",
  "webmail.sent": "메일을 보냈어요 — 배달 {{delivered}} · 큐 {{queued}}",
  "webmail.toPlaceholder": "받는 사람 (쉼표로 구분)",
  "webmail.ccPlaceholder": "참조 (선택)",
  "webmail.subjectPlaceholder": "제목",
  "webmail.parseWarn": "본문 일부를 해석하지 못했어요 — 원본(.eml)에서 전체 내용을 확인할 수 있어요.",
  "webmail.htmlNotice": "HTML 메일이에요 — 안전을 위해 텍스트만 표시해요. 전체는 원본(.eml)으로 확인해 주세요.",
  "webmail.backToList": "목록으로",
  "webmail.folderINBOX": "받은편지함",
  "webmail.folderSent": "보낸편지함",
  "webmail.folderTrash": "휴지통",
  "webmail.folderJunk": "스팸",
  "webmail.folderArchive": "보관함",
  "webmail.folderDrafts": "임시보관함",

  // ── filter rules ────────────────────────────────────────
  "filter.title": "메일 필터",
  "filter.description":
    "받은 메일이 받은편지함에 들어오기 전에 규칙을 순서대로 검사해요 — 처음 맞는 규칙 하나가 적용돼요. 스팸 격리가 필터보다 우선이에요.",
  "filter.empty": "필터가 없어요.",
  "filter.new": "새 필터",
  "filter.name": "이름",
  "filter.namePlaceholder": "이름 (예: 뉴스레터)",
  "filter.field": "대상",
  ...
  "filter.patternPlaceholder": "패턴 (대소문자 무시)",
  "filter.action": "동작",
  ...
  "filter.confirmDelete": "이 필터를 삭제할까요?",
